...
namespace kickbet_db {
    ...
    public partial class ModelDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            private global::System.Data.DataColumn columnPrediction;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public global::System.Data.DataColumn PredictionColumn {
                get {
                    return this.columnPrediction;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(string Full_name, string Email, string Prediction, string Phone, bool Gender) {
            ...
            internal void InitVars() {
                ...
                this.columnPrediction = base.Columns["Prediction"];
            ...
            private void InitClass() {
                ...
                this.columnPrediction = new global::System.Data.DataColumn("Prediction", typeof(string), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnPrediction);
                ...
                this.columnPrediction.MaxLength = 500;
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string Full_name {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Full name\' de la tabla \'Table\' es DBNull.", e);
                    }
                }
                set {
            ...
            public string Prediction {
                get {
                    try {
                        return ((string)(this[this.tableTable.PredictionColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Prediction\' de la tabla \'Table\' es DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.PredictionColumn] = value;
                }
            }
            ...
            public bool Gender {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Gender\' de la tabla \'Table\' es DBNull.", e);
                    }
                }
                set {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public bool IsPredictionNull() {
                return this.IsNull(this.tableTable.PredictionColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetPredictionNull() {
                this[this.tableTable.PredictionColumn] = global::System.Convert.DBNull;
            }
...
namespace kickbet_db.ModelDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_Prediction", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Prediction", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Prediction", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Prediction", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [Full name], [Email], [Prediction], [Phone], [Ge" +
                "nder]) VALUES (@Id, @Full_name, @Email, @Prediction, @Phone, @Gender);\r\nSELECT I" +
                "d, [Full name], Email, Prediction, Phone, Gender FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Prediction", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Prediction", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [Full name] = @Full_name, [Email] = @Email, [Prediction] = @Prediction, [Phone] = @Phone, [Gender] = @Gender WHERE (([Id] = @Original_Id) AND ((@IsNull_Full_name = 1 AND [Full name] IS NULL) OR ([Full name] = @Original_Full_name)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Prediction = 1 AND [Prediction] IS NULL) OR ([Prediction] = @Original_Prediction)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)));
SELECT Id, [Full name], Email, Prediction, Phone, Gender FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Prediction", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Prediction", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_Prediction", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Prediction", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Prediction", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Prediction", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::kickbet_db.Properties.Settings.Default.cn;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, [Full name], Email, Prediction, Phone, Gender FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_Full_name, string Original_Email, string Original_Prediction, string Original_Phone, global::System.Nullable<bool> Original_Gender) {
            ...
            if ((Original_Prediction == null)) {
                this.Adapter.DeleteCommand.Parameters[5].Value = ((object)(1));
                this.Adapter.DeleteCommand.Parameters[6].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.DeleteCommand.Parameters[5].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_Prediction));
            }
        ...
        public virtual int Insert(int Id, string Full_name, string Email, string Prediction, string Phone, global::System.Nullable<bool> Gender) {
            ...
            if ((Prediction == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[3].Value = ((string)(Prediction));
            }
            if ((Phone == null)) {
        ...
        public virtual int Update(int Id, string Full_name, string Email, string Prediction, string Phone, global::System.Nullable<bool> Gender, int Original_Id, string Original_Full_name, string Original_Email, string Original_Prediction, string Original_Phone, global::System.Nullable<bool> Original_Gender) {
            ...
            if ((Prediction == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Prediction));
            }
            if ((Phone == null)) {
            ...
            if ((Original_Prediction == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_Prediction));
            }
            if ((Original_Phone == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Full_name, string Email, string Prediction, string Phone, global::System.Nullable<bool> Gender, int Original_Id, string Original_Full_name, string Original_Email, string Original_Prediction, string Original_Phone, global::System.Nullable<bool> Original_Gender) {
            return this.Update(Original_Id, Full_name, Email, Prediction, Phone, Gender, Original_Id, Original_Full_name, Original_Email, Original_Prediction, Original_Phone, Original_Gender);
        }
    }
